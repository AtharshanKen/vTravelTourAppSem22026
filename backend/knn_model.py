...
def KNN_MD(NewRCat:list,dfscomb:pd.DataFrame,loc_id:str)->pd.DataFrame:
    ...
    cols_to_use = [ # var Not to be used but to tell what columns are being used
        'PedsSen_Count',
        'Weather_Temperature',
        'Weather_Wind_Gust',
    ...
    yPD,yPI = knn_model.kneighbors([X]) # [[,,]],[[,,]], the second list contains row indexs to dfscomb 
    # Predicition dist, Prediciton Index
